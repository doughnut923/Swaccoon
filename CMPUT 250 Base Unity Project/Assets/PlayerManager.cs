...
public class PlayerManager : MonoBehaviour
{
        ...
        foreach (GameObject character in SwappableCharacters)
            {
                ...
                {
                    character.GetComponent<TopDownPlayerBehaviour>()._playerState = PlayerState.SWAPPED_OUT;
                }
                else
                {
                    character.GetComponent<TopDownPlayerBehaviour>()._playerState = PlayerState.IDLE;
                }
            }
    }
    ...
    private void StartSwap()
    {
        if (_playerManagerState == PlayerManagerState.NOT_SWAPPING)
        {
            ...
            CurrentCharacter.GetComponent<TopDownPlayerBehaviour>()._playerState = PlayerState.SWAPPING;
