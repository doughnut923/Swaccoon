...
namespace SwacoonNarrative {
    ...
    /// </summary>
    public class SwacoonDialoguePortraitContainer : MonoBehaviour
    {
        //Singleton pattern
        private static SwacoonDialoguePortraitContainer _instance;
        public static SwacoonDialoguePortraitContainer Instance { get { return _instance; } }
        /// <summary>
        /// Constructor, defines singeton instance.
        /// </summary>
        public SwacoonDialoguePortraitContainer()
        {
            _instance = this;
        }
