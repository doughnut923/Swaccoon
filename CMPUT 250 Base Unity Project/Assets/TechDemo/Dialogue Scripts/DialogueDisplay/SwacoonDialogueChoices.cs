...
{
    public class SwacoonDialogueChoices : MonoBehaviour
    {
        [SerializeField] private Animator animator;

        public SwacoonDialogueButton[] buttons;
        ...
        {
            SwacoonDialogueFlags.SetFlag(postChoiceConditionEffects[_choice].flagID, postChoiceConditionEffects[_choice].expectedValue);
        ...
        public void ChoiceSelected(int choice)
        {
            ...
            SwacoonDialogueSystem.PlaySequence(dialogueCSVs[choice]);
