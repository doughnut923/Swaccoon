...
{
    public class SwacoonDialogueSounds : MonoBehaviour
    {
        ...
        //Singleton pattern
        private static SwacoonDialogueSounds _instance;
        public static SwacoonDialogueSounds Instance { get { return _instance; } }
        /// <summary>
        /// Constructor, defines singeton instance.
        /// </summary>
        public SwacoonDialogueSounds()
        {
            _instance = this;
        }
